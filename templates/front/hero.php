...
// Background image
$ip_hero_image            = ( IPR_Settings::hero_image() ) ? IPR_Settings::hero_image() : sprintf( '<img src="%s" alt="%s" />', IPRESS_CHILD_IMAGES_URL . 'images/hero.svg', esc_attr( $ip_hero_title ) );
...
<section class="hero">
	<div class="hero-content">
		...
		<p><a href="<?php echo esc_url( get_permalink( $ip_hero_button_link ) ); ?>" class="button"><?php echo esc_html( $ip_hero_button_text ); ?></a></p>
		<?php endif; ?>
	</div>
