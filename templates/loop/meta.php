...
<?php
	...
	$ip_post_date = sprintf( '<span class="post-date">%s %s</span>', __( 'Posted on', 'ipress-child' ), $ip_time_string ); 
	...
	if ( post_type_supports( get_post_type( get_the_ID() ), 'author' ) ) {
		...
		$post_author = sprintf( 
			...
			__( 'By <span class="post-author"><a href="%1$s" class="post-author-link" rel="author"><span class="post-author-name">%2$s</span></a></span>', 'freeplants' ),
