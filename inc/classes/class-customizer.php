...
if ( ! class_exists( 'IPR_Customizer' ) ) :
	...
	final class IPR_Customizer {
		...
		public function __construct() {
			...
			add_action( 'customize_register', 					[ $this, 'customize_register_woocommerce' ] );
			
			// Theme shortcode customizer api registration 
			add_action( 'customize_register', 					[ $this, 'customize_register_shortcode' ] );
		...
		public function setup_theme() {
			...
			$ip_custom_background_url	= (string) apply_filters( 'ipress_custom_background_default_image', '' );
			...
			$ip_custom_background_args 	= (array) apply_filters( 'ipress_custom_background_args', [
				'default-image'	=> ( empty( $ip_custom_background_url ) ) ? '' : esc_url_raw( $ip_custom_background_url ),
		...
		public function customize_register( WP_Customize_Manager $wp_customize ) {
			...
			$wp_customize->add_section( 'ipress_footer' , 
				[
		...
		public function customize_register_js( WP_Customize_Manager $wp_customize ) {
			...
			if ( true !== $ip_custom_js ) { return; }

			// Add section for additional scripts: header & footer 
			$wp_customize->add_section( 'ipress_custom_js',
				[
			...
			$wp_customize->add_setting( 'ipress_header_js',
				[
					'transport' 			=> 'refresh',
					'type' 					=> 'theme_mod',
			...
			$wp_customize->add_control( new WP_Customize_Code_Editor_Control( $wp_customize, 'ipress_header_js_html', [
			...
			// Add settings for custom footer scripts section
			$wp_customize->add_setting( 'ipress_footer_js',
				[
					'transport' 			=> 'refresh',
					'type' 					=> 'theme_mod',
					'capability'        	=> 'edit_theme_options',
			...
			$wp_customize->add_control( new WP_Customize_Code_Editor_Control( $wp_customize, 'ipress_footer_js_html', [
			...
			// Add settings for custom header admin scripts section
			$wp_customize->add_setting( 'ipress_header_admin_js',
				[
					'transport' 			=> 'refresh',
					'type' 					=> 'theme_mod',
					'capability'        	=> 'edit_theme_options',
			...
			$wp_customize->add_control( new WP_Customize_Code_Editor_Control( $wp_customize, 'ipress_header_admin_js_html', [
			...
			// Add settings for custom footer admin scripts section
			$wp_customize->add_setting( 'ipress_footer_admin_js',
				[
					'transport' 			=> 'refresh',
					'type' 					=> 'theme_mod',
					'capability'        	=> 'edit_theme_options',
			...
			$wp_customize->add_control( new WP_Customize_Code_Editor_Control( $wp_customize, 'ipress_footer_admin_js_html', [
		...
		public function customize_register_theme( WP_Customize_Manager $wp_customize ) {
			...
			$wp_customize->add_section( 'ipress_theme',
				[
			...
			$wp_customize->add_setting( 'ipress_breadcrumbs', 
				[
					'transport' 		=> $transport,
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			$wp_customize->add_control( 'ipress_breadcrumbs',
				[
			...
			// Section separator
			$wp_customize->add_setting( 'ipress_breadcrumbs_sep', [
			...
			// Optional content layout, remove as requited
			$wp_customize->add_setting( 'ipress_content_layout', [
				'default'			=> apply_filters( 'ipress_default_layout', ( is_rtl() ) ? 'left' : 'right' ),
				'sanitize_callback' => [ $this, 'sanitize_layout' ],
				'transport'			=> 'postMessage',
			] );

			$wpm->add_control( 'ipress_content_layout', [
				'label'		  => __( 'Page Content Layout', 'ipress-child' ),
				'section'	  => 'ipress_content_layout',
				'type'		  => 'radio',
				'section'     => 'ipress_theme',
				'priority'    => 30,
				'description' => __( 'Content section left or right layout.', 'ipress-child' ),
				'choices'	  => [
					''		=> __( 'Default, Full Width Content', 'ipress-child' ), 
					'left'	=> __( 'Content - Sidebar', 'ipress-child' ),
					'right' => __( 'Sidebar - Content', 'ipress-child' )
				],
			] );

			// Section separator
			$wp_customize->add_setting( 'ipress_content_sep', [
				'sanitize_callback' => '__return_true',
			] );
		...
		public function customize_register_hero( WP_Customize_Manager $wp_customize ) {
			...
			// Add front page hero. Most themes will have this, delete if not required
			$wp_customize->add_section( 'ipress_hero', 
				[
			...
			$wp_customize->add_setting( 'ipress_hero', 
				[
					'transport' 		=> $transport,
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			$wp_customize->add_control( 'ipress_hero',
				[
			...
			// Section separator
			$wp_customize->add_setting( 'ipress_hero_sep', [
				'sanitize_callback' => '__return_true',
			] );
			...
			$wp_customize->add_setting( 'ipress_hero_title', 
				[
					'transport' 		=> $transport,
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			$wp_customize->add_control( 'ipress_hero_title', 
				[
			...
			$wp_customize->add_setting( 'ipress_hero_description', 
				[
					'transport' 		=> $transport,
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			$wp_customize->add_control( 'ipress_hero_description', 
				[
			...
			$wp_customize->add_setting( 'ipress_hero_button_link', 
				[
			  		'transport' 		=> 'none',
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			$wp_customize->add_control( 'ipress_hero_button_link', 
				[
			...
			$wp_customize->add_setting( 'ipress_hero_button_text', 
				[
					'transport' 		=> $transport,
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			$wp_customize->add_control( 'ipress_hero_button_text', 
				[
			...
			$wp_customize->add_setting( 'ipress_hero_image', 
				[
					'transport' 		=> $transport,
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			$wp_customize->add_setting( 'ipress_hero_background_color', 
				[
					'transport' 		=> $transport,
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			$wp_customize->add_setting( 'ipress_hero_overlay', 
				[
					'transport' 		=> 'refresh',
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			$wp_customize->add_control( 'ipress_hero_overlay', 
				[
			...
			$wp_customize->add_setting( 'ipress_hero_overlay_color', 
				[
					'transport' 		=> $transport,
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			$wp_customize->add_setting( 'ipress_hero_overlay_opacity', 
				[
					'transport' 		=> $transport,
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			$wp_customize->add_control( 'ipress_hero_overlay_opacity', 
				[
		 ...
		 * @param object $wp_customize WP_Customise_Manager
		 */
		public function customize_register_woocommerce( WP_Customize_Manager $wp_customize ) {

			// Define settings & partials based on if selective refresh is active
			$transport = ( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';

			// Add the theme section. Won't show until settings & controls added
			$wp_customize->add_section( 'ipress_woocommerce',
				[
					'panel'    => 'woocommerce',
					'title' 		=> __( 'Theme', 'ipress' ),
			...
			// Add setting for breadcrumbs
			$wp_customize->add_setting( 'ipress_woocommerce_breadcrumbs', 
				[
					'transport' 		=> $transport,
					'type' 				=> 'theme_mod',
					'capability'    	=> 'edit_theme_options',
			...
			// Add checkbox control for breadcrumbs setting
			$wp_customize->add_control( 'ipress_woocommerce_breadcrumbs',
				[
					'label'       => __( 'Breadcrumbs', 'ipress' ),
			...
			// Section separator
			$wp_customize->add_setting( 'ipress_woocommerce_sep', [
				'sanitize_callback' => '__return_true',
			] );
		...
		/**
		 * Set up customizer shortcode section and settings
		 *
		 * @param object $wp_customize WP_Customise_Manager
		 */
		public function customize_register_shortcode( WP_Customize_Manager $wp_customize ) {

			// Define settings & partials based on if selective refresh is active
			$transport = ( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';

			// Add inner pages shortcode section. Won't show until settings added
			$wp_customize->add_section( 'ipress_shortcode', 
				[
					'title' 			=> __( 'Shortcode', 'ipress' ),
					'description'		=> esc_html__( 'Theme shortcode settings', 'ipress' ),
					'priority' 			=> 270,
					'active_callback' 	=> function() use ( $wp_customize ) {
			...
			// Section separator
			$wp_customize->add_setting( 'ipress_shortcode_sep', [
				'sanitize_callback' => '__return_true',
			] );
			...
			$wp_customize->add_control(
				new WP_Customize_Separator_Control (
					$wp_customize,
						'ipress_shortcode_sep',
						[
							'section' 	=> 'ipress_shortcode',
							'priority'	=> 5
						]
				)
			);
		...
		public function customize_register_partials( WP_Customize_Manager $wp_customize ) {
			...
			// Hero title markup
			$wp_customize->selective_refresh->add_partial( 'ipress_hero_title', 
				[
					'selector' 			=> '.hero-title',
					'settings' 			=> 'ipress_hero_title',
			...
			$wp_customize->selective_refresh->add_partial( 'ipress_hero_description', 
				[
			...
			// Hero image markup
			$wp_customize->selective_refresh->add_partial( 'ipress_hero_image', 
				[
			...
			$wp_customize->selective_refresh->add_partial( 'ipress_hero_background_color', 
				[
					'selector' 			=> '#hero-css',
					'settings' 			=> 'ipress_hero_background_color',
			...
			$wp_customize->selective_refresh->add_partial( 'ipress_hero_button_text', 
				[
			...
			$wp_customize->selective_refresh->add_partial( 'ipress_hero_overlay_color', 
				[
					'selector' 			=> '#hero-css',
					'settings' 			=> 'ipress_hero_overlay_color',
					'render_callback' 	=> self::hero_css()
			...
			$wp_customize->selective_refresh->add_partial( 'ipress_hero_overlay_opacity', 
				[
					'selector' 			=> '#hero-css',
					'settings' 			=> 'ipress_hero_overlay_opacity',
					'render_callback' 	=> self::hero_css()
		...
		public function layout_class( $classes ) {
			...
			// Check it's set, otherwise assume full width
			$ip_content_layout = get_theme_mod( 'ipress_content_layout', '' );
			if ( ! empty( $ip_content_layout ) ) {
				$classes[] = ( $ip_content_layout === 'left' ) ? 'content-sidebar' : 'sidebar-content';
			}
		...
		public function validate_categories( $validity, $categories ) {
			...
			if ( ! preg_match( '/^[\d\s,]+$/', $categories ) ) {
			    $validity->add( 'categories_format', __( 'Comma separated list of category IDs only.' ) );	
			}
			return $validity;
		}
		...
		public static function opacity( $selector, $property, $theme_mod ) {
			...
			// Return value?
			return ( $theme_mod === 0 ) ? '' : sprintf( '%s { %s:%s; }', $selector, $property, number_format( $theme_mod / 100, 2 ) );
		}

		/**
		 * Output header css for hero section
		 */
